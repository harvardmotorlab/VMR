    ...
    if started==0    % inside start circle wait time (not yet started)
        ...
        if curtime <= t_a + wait_time2 && ~ismember(movement_type(ii),nfbret)
            ...
            if tgt_set~='f'&&tgt_set~='g'&&tgt_set~='l'&&tgt_set~='m'&&tgt_set~='r'&&tgt_set~='s'
                ...
                elseif ((tgt_set=='e'||tgt_set=='h'||tgt_set=='i'|| tgt_set=='j'||tgt_set=='k'||tgt_set=='n'||tgt_set=='o'|| tgt_set=='p'|| tgt_set=='q'|| tgt_set=='t'|| tgt_set=='u')&&(cursor_nofeedback(ii)~=0))  %%insert 3 trials in all training block
            ...
            % %%======================================================
            %%show the target and red ring (selected by subjects), in the
            %%trials of train or generalization blocks selecting red ring that there are no cursor feedback both inward and outward movements  
            %%general learning block with selecting aiming target
            if  (tgt_set=='g'||tgt_set=='l'||tgt_set=='s')||((tgt_set=='c'||tgt_set=='d'||tgt_set=='e'||tgt_set=='h'||tgt_set=='i'|| tgt_set=='j'||tgt_set=='k'||tgt_set=='n'||tgt_set=='o'|| tgt_set=='p'|| tgt_set=='q'|| tgt_set=='t'|| tgt_set=='u')&& (cursor_nofeedback(ii)==0))
                ...
                if (tgt_set=='g'||tgt_set=='l'||tgt_set=='s')||((tgt_set=='e'||tgt_set=='h'||tgt_set=='i'|| tgt_set=='j'||tgt_set=='k'||tgt_set=='n'||tgt_set=='o'|| tgt_set=='p'|| tgt_set=='q'|| tgt_set=='t'|| tgt_set=='u')&& (cursor_nofeedback(ii)==0))
            ...
            %%=========================================================================
            % make circle at p1
            %%target shown in different shape in no aiming target and aiming target of generalization  blocks
            if tgt_set~='f'&&tgt_set~='m'&&tgt_set~='r'            %other blocks, curspr target is displayed by a circle
            ...
            elseif (tgt_set=='g'||tgt_set=='l'||tgt_set=='s')||((tgt_set=='c'||tgt_set=='d'||tgt_set=='e'||tgt_set=='h'||tgt_set=='i'|| tgt_set=='j'||tgt_set=='k'||tgt_set=='n'||tgt_set=='o'|| tgt_set=='p'|| tgt_set=='q'|| tgt_set=='t'|| tgt_set=='u')&& (cursor_nofeedback(ii)==0))  
