...
while ~any(buttons(2)) &&ii<length(philist)    %~any(buttons(2:end)), the button of corsor is not pressed,the button is 3 dim vector[~,~,~]which respresents left, mid and right button of corsor. if the rigjt botton is not pressed, the code in which is goning on
    ...
    if started==0    % inside start circle wait time (not yet started)
        ...
        if curtime <= t_a + wait_time2 && ~ismember(movement_type(ii),nfbret)
            ...
            if tgt_set~='f'&&tgt_set~='g'&&tgt_set~='j'&&tgt_set~='k'&&tgt_set~='n'&&tgt_set~='o'
                ...
                elseif (tgt_set=='e'||tgt_set=='p'||tgt_set=='q')||((tgt_set=='h'||tgt_set=='i'||tgt_set=='l'|| tgt_set=='m')&&( ii > 6))  %%insert 3 trials in all training block
                    %                 elseif (tgt_set=='e'||tgt_set=='h'||tgt_set=='l')||((tgt_set=='i'|| tgt_set=='m') &&( ii > 6)) %%insert 3 trials in the second training block
                    cursor_tgt_angle = atan2( diff(y1list(ii-1:ii)), diff(x1list(ii-1:ii)) );
                    if ~aiming_flag && (mod(ii,2)==0)
                        ...
                        elseif ii==2&&(tgt_set=='p'||tgt_set=='q')  % download the position of aiming target in last block
            ...
            if  (tgt_set=='g'||tgt_set=='j'||tgt_set=='o')||( (tgt_set=='h'||tgt_set=='i'||tgt_set=='l'|| tgt_set=='m')&& (ii<7) )
                %             if (tgt_set=='g'||tgt_set=='j'||tgt_set=='o')||( (tgt_set=='i'|| tgt_set=='m')&& (ii<7) )  % insert 3 trials in second train blcok
                cursor_tgt_angle = atan2( diff(y1list(ii-1:ii)), diff(x1list(ii-1:ii)));
                if ~aiming_flag && (mod(ii,2)==0)
                    if ii==2&&((tgt_set=='i'||tgt_set=='l'|| tgt_set=='m'))  % download the position of aiming target in last block
                        load('aimingtag_out.mat')
                        testangle_out=testangle_out;
                    elseif tgt_set=='h'&& ii==2
                        testangle_out=cursor_tgt_angle;
                    end
                    aiming_flag = 1;
                end
                if mod(ii,2)==0
                    while ~any(curkey1==uparrow) && curkey~=1
                        ...
                        elseif ((tgt_set=='h'||tgt_set=='i'||tgt_set=='l'|| tgt_set=='m'))
                            testcursorx_out=xstart+movelen*cos(testangle_out);
            ...
            %%=========================================================================
            % make circle at p1
            if tgt_set~='f'&&tgt_set~='k'&&tgt_set~='n'            %other blocks, target is a circle
            ...
            %==============================================================
            if tgt_set=='f'|| tgt_set=='k'|| tgt_set=='n'   %%Aiming target is fixed
            ...
            elseif (tgt_set=='g'|| tgt_set=='j'|| tgt_set=='o')||( (tgt_set=='h'||tgt_set=='i'||tgt_set=='l'|| tgt_set=='m') && (ii<7) )
                
                %             elseif (tgt_set=='g'|| tgt_set=='j'|| tgt_set=='o')||((tgt_set=='i'|| tgt_set=='m')&&(ii<7))  %insert 3 trials in second train block
            ...
            if  ( tgt_set=='a'||tgt_set=='b'||tgt_set=='c'||tgt_set=='d'||tgt_set=='e'||tgt_set=='p'||tgt_set=='q') || (( tgt_set=='h'||tgt_set=='i'||tgt_set=='l'||tgt_set=='m') &&(ii > 6))
                %                  if  ( tgt_set=='a'||tgt_set=='b'||tgt_set=='c'||tgt_set=='d'|| tgt_set=='e'|| tgt_set=='h'|| tgt_set=='l')||((tgt_set=='i'||tgt_set=='m') &&(ii > 6))
            ...
            elseif (tgt_set=='f'|| tgt_set=='g'|| tgt_set=='j'||tgt_set=='k'|| tgt_set=='n'|| tgt_set=='o')||((tgt_set=='h'||tgt_set=='i'||tgt_set=='l'|| tgt_set=='m')&&(ii<7))
                
                %           elseif (tgt_set=='f'|| tgt_set=='g'|| tgt_set=='j'||tgt_set=='k'|| tgt_set=='n'|| tgt_set=='o')||(tgt_set=='i'|| tgt_set=='m')&&(ii<7))
    ...
    if tgt_set=='a'||tgt_set=='b'
        ...
        if  (tgt_set=='c'||tgt_set=='d'||tgt_set=='e'||tgt_set=='p'||tgt_set=='q') || (( tgt_set=='h'||tgt_set=='i'||tgt_set=='l'||tgt_set=='m') &&(ii > 6))  %%block except the generalization
            %                  if  (tgt_set=='c'||tgt_set=='d'|| tgt_set=='e'|| tgt_set=='h'|| tgt_set=='l')||((tgt_set=='i'||tgt_set=='m') &&(ii > 6))
            if mod(ii,2)==0
                if (vis_feedback(ii)==1 && (jumpthegun==0 && firsttimeout ==1) || sqrt((dx-rotx)^2 + (dy-roty)^2) < startvisthresh) || ((ismember(movement_type(ii),nfbret) || started==0) && sqrt((dx-rotx)^2 + (dy-roty)^2) < startvisthresh) || (~ismember(movement_type(ii),nfbret) && ismoving==0)
                    Screen('DrawTexture', win, cursortext,[],cursor,[],[],[],cursorcol);
                    Screen('DrawTexture', win, cursortext,[],screenoffset-cursor(1,[3,4,1,2]),[],[],[],nofeedcursorcol);
        ...
        elseif (tgt_set=='f'|| tgt_set=='g'|| tgt_set=='j'||tgt_set=='k'|| tgt_set=='n'|| tgt_set=='o')||((tgt_set=='h'||tgt_set=='i'||tgt_set=='l'|| tgt_set=='m')&&(ii<7)) %% generalization block
            %   elseif (tgt_set=='f'|| tgt_set=='g'|| tgt_set=='j'||tgt_set=='k'|| tgt_set=='n'|| tgt_set=='o')||(tgt_set=='i'|| tgt_set=='m')&&(ii<7))
